...
-   [A homes system UI.](../player-menu/homes)
-   [A TPA system UI.](../player-menu/tpa)
-   [A warps system UI.](../player-menu/warps)
-   [A bounty system UI.](../player-menu/bounties)
-   [A leaderboards UI.](../player-menu/leaderboards)
-   [A button to access the Server Shops UI.](../player-menu/server-shops)
-   [A button to access the Player Shops UI.](../player-menu/player-shops)
