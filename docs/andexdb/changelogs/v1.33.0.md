...
The player menu can be accessed through either the "Player Menu" item, or the [`\playermenu`{lang=acmd}](../commands-list/-playermenu) command.
...
-   Made the following changes to a few methos of the `savedPlayer`{lang=ts} class:
