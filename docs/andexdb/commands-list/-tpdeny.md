...
Denies teleport requests for the [TPA system](../systems/tpa).
...
`\tpdeny <player: target[allowMultiple=true,playersOnly=true]>`{lang=andexdbcmd}
...
Specifies the player(s) to deny the TPA requests from.
...
Any
        ...
        <tr>
            <td>
                All of the TPA requests were unable to be denied.
            </td>
            <td align="center" rowspan="1" class="tc-no"> Failed</td>
        </tr>
        <tr>
            <td>
                Some but not all of the TPA requests were unable to be denied.
            </td>
